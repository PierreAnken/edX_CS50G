...
function GenerateQuadsBricks(atlas)
    ...
    bricks = table.slice(GenerateQuads(atlas, brickWidth, brickHeight), 1, 21)

    -- locked brick
    lockedBrick = table.slice(GenerateQuads(atlas, brickWidth, brickHeight), 24, 24)
    bricks[#bricks+1] = lockedBrick[1]
